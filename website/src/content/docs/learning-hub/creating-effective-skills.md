...
copilot skill add ./my-skill/ --project # add as a project-scoped skill (v1.0.84+)
...
> **Note (v1.0.84+)**: The `--project` flag replaces the old `copilot plugins install --skill --scope project` spelling. The `--scope` flag has been removed.
