...
**Voice Mode**: Prefer speaking to typing? Try [Using Voice Mode with GitHub Copilot](voice-mode/) to have a natural spoken conversation with a Copilot agent in VS Code — and interrupt it mid-response *(VS Code 1.137+, experimental)*.
