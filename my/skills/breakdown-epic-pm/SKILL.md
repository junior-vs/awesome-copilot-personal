...
When describing technical and architectural requirements, do not assume SaaS as default. Consider and mention alternative architecture patterns when relevant, such as:
	...
	- Event-driven
	- Serverless
	- Outras arquiteturas relevantes ao contexto

If the epic is for a Java application, recommend frameworks such as Quarkus or Spring Boot, justifying the choice according to the epic context.
